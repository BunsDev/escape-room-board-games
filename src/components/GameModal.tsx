        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div>
              ...
              <p className="text-white">{`${game.min_players}-${game.max_players}`}</p>
            </div>
            <div>
              <p className="text-gray-400">Duration</p>
              <p className="text-white">{`${game.duration_min}-${game.duration_max} min`}</p>
            </div>
            <div>
              <p className="text-gray-400">Publisher</p>
              <p className="text-white">{game.publishers?.name}</p>
            </div>
          </div>

          
          <div className="mt-6 flex justify-between items-center">
            {game.price && <span className="text-2xl font-bold text-purple-400">{game.price}</span>}
